...
while true; do
	if [ -f notifications.txt ]; then
	    while IFS='' read -r line || [[ -n "$line" ]]; do
			...
			TOKEN=`cat /home/karanvasnani/Desktop/AlzCare/pushNotifications/token.dat`
			...
			echo -e $POST_DATA_START > /home/karanvasnani/Desktop/AlzCare/pushNotifications/multipart_body.txt
			...
			rm /home/karanvasnani/Desktop/AlzCare/pushNotifications/tmp/pipe.wav
			ln -s /dev/stdout /home/karanvasnani/Desktop/AlzCare/pushNotifications/tmp/pipe.wav
			pico2wave -w /home/karanvasnani/Desktop/AlzCare/pushNotifications/tmp/pipe.wav "${QUESTION}" | tee /home/karanvasnani/Desktop/AlzCare/pushNotifications/pico2wav.wav | sox - -c 1 -r 16000 -e signed -b 16 -t wav - >> /home/karanvasnani/Desktop/AlzCare/pushNotifications/multipart_body.txt

			# Then we append closing boundary to request body file.
			echo -e $POST_DATA_END >> /home/karanvasnani/Desktop/AlzCare/pushNotifications/multipart_body.txt
			...
			curl -s -X POST \
			  ...
			  | tee /home/karanvasnani/Desktop/AlzCare/pushNotifications/response.mp3 | play -t mp3 -q -
